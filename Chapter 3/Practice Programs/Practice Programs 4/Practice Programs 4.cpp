...
int main()
{
    ...
    void prnt_info(std::string horoscope, int dd, int mm, int yyyy, bool leap, std::string element);
    ...
    do
    {
        ...
        prnt_info(result, user.get_day(), user.get_month(), user.get_year(), user.get_leap(), element(result));
...
std::string element(std::string element)
{
    if (element == "Aries" || element == "Leo" || element == "Sagittarius")
    {
        element = "FIRE";
    }
    if (element == "Taurus" || element == "Virgo" || element == "Capricorn")
    {
        element = "EARTH";
    }
    if (element == "Gemini" || element == "Libra" || element == "Aquarius")
    {
        element = "AIR";
    }
    if (element == "Cancer" || element == "Scorpio" || element == "Pisces")
    {
        element = "WATER";
    }
